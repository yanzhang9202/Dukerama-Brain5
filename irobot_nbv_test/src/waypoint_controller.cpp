...
void waypoint_controller::loadBase(){
	string filename = "/home/dukerama/hydro_catkin/src/irobot_auction/include/BaseCalib/Hc2m_left.txt";
	Hc2m_left = loadMatrix(4, 4, filename);
	if (show_Base_info){
		cout << "Hc2m_left: " << endl << Hc2m_left << endl << endl;
	}

	filename = "/home/dukerama/hydro_catkin/src/irobot_auction/include/BaseCalib/Hc2m_right.txt";
	Hc2m_right = loadMatrix(4, 4, filename);
	if (show_Base_info){
		cout << "Hc2m_right: " << endl << Hc2m_right << endl << endl;
	}

	filename = "/home/dukerama/hydro_catkin/src/irobot_auction/include/BaseCalib/r_sb.txt";
	...
	filename = "/home/dukerama/hydro_catkin/src/irobot_auction/include/BaseCalib/r_hs.txt";
